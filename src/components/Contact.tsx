        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <div className="bg-card border border-muted/30 rounded-xl p-8 shadow-lg">
              <h3 className="text-xl font-semibold mb-6 text-center lg:text-left">Send Us A Message</h3>
              <ContactForm />
            </div>
          </div>
          ...
          <div>
            <div className="bg-card border border-muted/30 rounded-xl p-8 shadow-lg h-full">
              <h3 className="text-xl font-semibold mb-6 text-center lg:text-left">Contact Information</h3>
              
              <div className="space-y-8">
                <div className={`flex ${isMobile ? 'flex-col items-center' : 'items-start'}`}>
                  <div className={`p-3 rounded-full bg-primary/10 ${isMobile ? 'mb-3' : 'mr-4'}`}>
