...
export default function ToolsNexusView({ profile }: { profile: any }) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-white/40 uppercase tracking-widest font-bold">
            Explore community utility apps, tools, and sandboxed developer specs
          </p>
        </div>

        <Dialog open={isSubmitOpen} onOpenChange={setIsSubmitOpen}>
          <DialogTrigger asChild>
            <Button className="rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-semibold flex items-center gap-2 px-5 h-12 shadow-lg shadow-emerald-950/20 border-none">
            ...
            <form onSubmit={handleCreateTool} className="space-y-4 py-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    id="category"
                    className="w-full h-10 bg-black/40 border border-white/10 rounded-xl text-xs px-2 text-zinc-100 animate-none transition-none"
                    value={formCategory}
              ...
              <Button type="submit" className="w-full bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl h-11 font-semibold mt-4 border-none">
                Publish Inside App on Nexus
              </Button>
            </form>
          </DialogContent>
